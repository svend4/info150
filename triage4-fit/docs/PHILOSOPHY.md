...
Why triage4-fit exists as a **separate package** rather than a
...
triage4-fit is a **consumer wellness library**. It has zero
...
1. **Claims bleed.** A process that imports `triage4` carries
   ...
   - triage4-fit being pushed into clinical framing (triggering
