...
Why triage4-stroll exists as a **separate package** rather than a
...
triage4-stroll is a **consumer wellness library**. It has zero
...
1. **Claims bleed.** A process that imports `triage4` carries
   ...
   - triage4-stroll being pushed into clinical framing (triggering
