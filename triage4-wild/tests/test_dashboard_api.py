"""Tests for triage4_wild.ui.dashboard_api."""
...
from triage4_wild.ui.dashboard_api import app  # noqa: E402
...
def test_export_html(client: TestClient) -> None:
    ...
    assert res.status_code == 200 and "triage4-wild" in res.text
