...
| Run a sibling's Web UI — copy-paste recipe (Linux/macOS + Windows) | [`<sibling>/web_ui/README.md`](DEMOS.md#detailed-run-instructions--per-sibling-readmes) (one per sibling) |
